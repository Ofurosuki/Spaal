...
```
uv run python datasets_generator/hist_matrix_generator.py --lidar-type PCD_VLP32c --pcd-directory ./nuscenes_data --num-frames 1 --output-dir ./pcd_datasets --spoofer-angle 90 --spoofer-altitude 50
```
